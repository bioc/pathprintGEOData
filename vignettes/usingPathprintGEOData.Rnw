...
\section{Description}
This package contains the data used by pathprint package, including a fingerprint matrix and a metadata data frame. The fingerprint matrix contains ternary scores for 633 pathways that have been pre-calculated for 188,390 publicly available arrays from the GEO corpus, spanning 6 species (Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio, Drosophila melanogaster and Caenorhabditis elegans) and 31 platforms. The metadata data frame includes experiment IDs, platform, species and a selection of the record description provided by the GEO database.
...
ds = c("chipframe", "genesets","pathprint.Hs.gs"
       ,"platform.thresholds","pathprintSummarizedGEOData", "pluripotents.frame")
data(list = ds)
...
top.noSeed.meta<-GEO.metadata.matrix[
	match(
	  head(rownames(geo.pluripotentDistance.noSeed), 1000),
